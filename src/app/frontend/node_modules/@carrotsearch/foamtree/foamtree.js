...
k){k=k.te;var r=c[k];void 0===r&&(r={},c[k]=r);r[" "]=n.measureText(" ").width;r["\u2026"]=n.measureText("\u2026").width}function l(n,k,r){var y,v=k.text.split(/(\n|[ \f\r\t\v\u2028\u2029]+|\u00ad+|\u200b+)/),w=[],z=[],E=v.length>>>1;for(y=0;y<E;y++)w.push(v[2*y]),z.push(v[2*y+1]);2*y<v.length&&(w.push(v[2*y]),z.push(void 0));r=c[r];for(y=0;y<w.length;y++)v=w[y],E=r[v],void 0===E&&(E=n.measureText(v).width,r[v]=E);k.Tc=w;k.Qf=z}function g(n){for(var k=n.text.split(/\s+/),r=[],y={".":!0,",":!0,";":!0,
