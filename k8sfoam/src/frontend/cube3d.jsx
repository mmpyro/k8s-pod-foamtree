...
function Cube({ pod, hue, onHover, onLeave, highlight, highlightActive, onSelect }) {
...
function Plate({ node, hue, onFocus, onHover, onLeave, highlight, highlightActive, onSelect }) {
...
function Scene3D({
  nodes, zoom, hueOf, memUnit, fmtMem, onFocus,
